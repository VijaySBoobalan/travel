    ...
    <div class="  justify-content-between d-flex">
      ...
      <div class="menucontainer">
        <nav id="nav-menu-container" class=" ">
          <ul class="nav-menu">
            <li><a href="{{ url('/') }}"><i class="fa fa-home" aria-hidden="true" style="font-size: 23px"></i></a></li>
            <li class="menu-has-children"><a class="" href="#">Holiday packages</a>
          ...
          <li><a href="{{ url('/miec') }}">M.I.C.E</a></li>
