...
<section class="popular-destination-area  visible-md visible-lg">
    ...
    <div class="row d-flex justify-content-center">
      <div class="menu-content pb-70 col-lg-8">
        <div class="title text-center">
          <div class=" h">Popular Destinations</div>
          <p style="font-size: 16px">"The world makes way for the man who knows where he is going"- Ralph Waldo Emerson</p>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-lg-3">
        <div class="single-destination relative">
          <div class="thumb relative">
            ...
            <img class="img-fluid" src="{{ url('img/singapore.jpg') }}" alt=""width="100%" height="100%">
          </div>
          <div class="desc">
            <div class="pp1">SINGAPORE</div>
            <p class="pp2"></p>
          </div>
        </div>
      </div>
      <div class="col-lg-3">
        <div class="single-destination relative">
          <div class="thumb relative">
            <div class="overlay overlay-bg"></div>
            <img class="img-fluid" src="{{ url('img/malaysia.jpg') }}" alt=""width="100%" height="100%">
          </div>
          <div class="desc">
            <div class="pp1">MALAYSIA</div>
            <p></p>
          </div>
        </div>
      </div>
      <div class="col-lg-3">
        <div class="single-destination relative">
          <div class="thumb relative">
            <div class="overlay overlay-bg"></div>
            <img class="img-fluid" src="{{ url('img/thailand.jpg') }}" alt=""width="100%" height="100%">
          </div>
          <div class="desc">
            <div class="pp1">THAILAND</div>
            <p></p>
          </div>
        </div>
      </div>
      <div class="col-lg-3">
        <div class="single-destination relative">
          <div class="thumb relative">
            <div class="overlay overlay-bg"></div>
            <img class="img-fluid" src="{{ url('img/nyc_usa.jpg') }}" alt=""width="100%" height="100%">
          </div>
          <div class="desc">
            <div class="pp1">NEW YORK</div>
            <p></p>
          </div>
        </div>
      </div>
    </div>
    <div class="row section-gap-small">
      <div class="col-lg-3">
        <div class="single-destination relative">
          <div class="thumb relative">
            <div class="overlay overlay-bg"></div>
            <img class="img-fluid" src="{{ url('img/hongkong.jpg') }}" alt=""width="100%" height="100%">
          </div>
          <div class="desc">
            <div class="pp1">HONGKONG</div>
            <p></p>
          </div>
        </div>
      </div>
      <div class="col-lg-3">
        <div class="single-destination relative">
          <div class="thumb relative">
            <div class="overlay overlay-bg"></div>
            <img class="img-fluid" src="{{ url('img/china.jpg') }}" alt=""width="100%" height="100%">
          </div>
          <div class="desc">
            <div class="pp1">CHINA</div>
            <p></p>
          </div>
        </div>
      </div>
      <div class="col-lg-3">
        <div class="single-destination relative">
          <div class="thumb relative">
            <div class="overlay overlay-bg"></div>
            <img class="img-fluid" src="{{ url('img/austalia.jpg') }}" alt=""width="100%" height="100%">
          </div>
          <div class="desc">
            <div class="pp1">AUSTRALIA</div>
            <p> </p>
          </div>
        </div>
      </div>
      <div class="col-lg-3">
        <div class="single-destination relative">
          <div class="thumb relative">
            <div class="overlay overlay-bg"></div>
            <img class="img-fluid" src="{{ url('img/newzealand.jpg') }}" alt=""width="100%" height="100%">
          </div>
          <div class="desc">
            <div class="pp1">NEWZEALAND</div>
            <p></p>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    ...
    <p style="text-align: center;font-size: 16px">"THE WORLD MAKES WAY FOR THE MAN WHO KNOWS WHERE HE IS GOING"- RALPH WALDO EMERSON</p>
    <div class="row">
...
<section class="popular-destination-area section-gap-small2 visible-ms visible-xs ">
  <div class="container">
    <div class="row d-flex justify-content-center">
      <div class="menu-content pb-70 col-lg-8">
        <div class="title text-center">
          <h1 class="mb-10 h" style="">Popular Destinations</h1>
          <p style="font-size: 14px">"THE WORLD MAKES WAY FOR THE MAN WHO KNOWS WHERE HE IS GOING"- RALPH WALDO EMERSON</p>
        </div>
      </div>
    </div>
...
<div class="container section-gap visible-md visible-lg" style="margin-top:-1%;">
...
<!--Why you choose us-->
<div class="why visible-md visible-lg" style="margin-top: -5%">
  <div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="{{ ('img/why.jpg') }}" data-speed="0.8"></div>
  <div class="container">
    <div class="row">
      <div class="col text-center">
        <div class="section_subtitle">simply amazing places</div>
        <div class="section_title"><h2 style="color: white;">Why choose us?</h2></div>
      </div>
    </div>
    <div class="row why_row">
      ...
      <div class="col-lg-4 why_col">
        <div class="why_item">
          <div class="why_image">
            <img src="{{ url('img/why_2.jpg') }}" alt="">
            <div class="why_icon d-flex flex-column align-items-center justify-content-center">
              <img src="{{ url('img/why_2.svg') }}" alt="">
            </div>
          </div>
          <div class="why_content text-center">
            <div class="why_title">Great Team</div>
            <div class="why_text">
              <p>We swear by the theory of keeping our customers happy and hence giving suprises for them in the form of irrestible discounts and offers from time to time.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 why_col">
        <div class="why_item">
          <div class="why_image">
            <img src="{{ url('img/why_3.jpg') }}" alt="">
            <div class="why_icon d-flex flex-column align-items-center justify-content-center">
              <img src="{{ url('img/why_3.svg') }}" alt="">
            </div>
          </div>
          <div class="why_content text-center">
            <div class="why_title">Vision</div>
            <div class="why_text">
              <p>We don’t aim to be your travel agent, we strive to be your holiday partners forever.</p>
            </div>
          </div>
        </div>
      </div>
...
<div class="why visible-ms visible-xs" style="margin-top: -10%">
  <div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="{{ url('img/why.jpg') }}" data-speed="0.8"></div>
  <div class="container">
    <div class="row">
      <div class="col text-center">
        <div class="section_subtitle" style="margin-top: -100px">simply amazing places</div>
        <div class="section_title"><h3 style="color: white;">Why choose us?</h3></div>
      </div>
    </div>
    <div class="row why_row">
      <!-- Why item -->
...
<section class="ftco-section testimony-section visible-md visible-lg" style="margin-top: -1%">
  ...
  <section class="ftco-section testimony-section visible-ms visible-xs" style="margin-top: -16%">
    <div class="container">
      <div class="row justify-content-center mb-5 pb-5">
        <div class="col-md-7 text-center heading-section ftco-animate">
          <div style="" class="h">Our Agents</div>
        </div>
      </div>
